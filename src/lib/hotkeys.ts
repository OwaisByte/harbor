...
export const HOTKEYS: HotkeyDef[] = [
  ...
  { id: "playerSeekBackShort", scope: "Player", group: "Seeking", label: "Short seek back", description: "Jump back by the shorter Short seek step set under Behavior.", defaultBinding: "shift+ArrowLeft" },
  { id: "playerSeekForwardShort", scope: "Player", group: "Seeking", label: "Short seek forward", description: "Jump forward by the shorter Short seek step set under Behavior.", defaultBinding: "shift+ArrowRight" },
...
export function shouldHandleGlobalKeyboardEvent(e: KeyboardEvent): boolean {
  if (typeof document !== "undefined" && !document.hasFocus()) return false;
  return !e.isComposing && e.key !== "Process" && !isTypingTarget(e);
}
