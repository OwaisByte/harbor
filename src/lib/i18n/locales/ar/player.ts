const player: Record<string, string> = {
  ...
  "Hide HI/SDH": "إخفاء ترجمة الصمّ وضعاف السمع",
  "Hide filters": "إخفاء الفلاتر",
  "Toggle filters": "إظهار الفلاتر",
  "Sort by source": "الترتيب حسب المصدر",
  "Couldn't add, try again": "تعذّرت الإضافة، حاول مرة أخرى",
  "Couldn't download, try again": "تعذّر التنزيل، حاول مرة أخرى",
  Added: "أُضيفت",
  "Limit reached": "تم بلوغ الحد الأقصى",
